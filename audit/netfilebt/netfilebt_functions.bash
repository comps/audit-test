...
# File History
# 11/30/2010
# This file is nearly the same as the one in the network directory by the name
# of network_functions.bash Items not needed have been eliminated and is
# created as a different file to allow changes particular to ebtables in the
# future which may not be needed for network tests as is the case in the
# netfilter sub-directory for iptables/ip6tables filtering
#
