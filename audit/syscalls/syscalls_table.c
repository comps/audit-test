...
static struct syscall_tests syscall_table[] = {
    ...
    { "ipc-msgctl-set", &test_msgctl_set },
    { "ipc-msgget", &test_msgget },
    { "ipc-msgrcv", &test_msgrcv },
    { "ipc-msgsnd", &test_msgsnd },
    { "ipc-semctl-rmid", &test_semctl_rmid },
    { "ipc-semctl-set", &test_semctl_set },
    { "ipc-semget", &test_semget },
    { "ipc-semop", &test_semop },
    { "ipc-semtimedop", &test_semtimedop },
    { "ipc-shmat", &test_shmat },
    { "ipc-shmctl-rmid", &test_shmctl_rmid },
    { "ipc-shmctl-set", &test_shmctl_set },
    { "ipc-shmget", &test_shmget },
    ...
    { "mknod", &test_mknod }, 
    { "mount", &test_mount }, 
    { "msgctl-rmid", &test_msgctl_rmid }, 
    { "msgctl-set", &test_msgctl_set }, 
    { "msgget", &test_msgget }, 
    { "msgrcv", &test_msgrcv },
    { "msgsnd", &test_msgsnd },
    { "open", &test_open },
    ...
    { "rename", &test_rename }, 
    { "rmdir", &test_rmdir }, 
    { "semctl-rmid", &test_semctl_rmid }, 
    { "semctl-set", &test_semctl_set }, 
    { "semget", &test_semget }, 
    { "semop", &test_semop },
