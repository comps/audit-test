/**********************************************************************
  ...
  **
  **
  **  FILE       : test_removexattr_einval.c
  **
  **  PURPOSE    : To test the removexattr library call auditing.
  **
  **  DESCRIPTION: The test_removexattr_einval() function builds into the
 ...
 int test_removexattr_einval(laus_data* dataPtr) {
   ...
   dataPtr->laus_var_data.syscallData.code = AUDIT_removexattr;
   ...
   // Execute system call
   dataPtr->laus_var_data.syscallData.result = syscall( __NR_removexattr, path, name );
