/**********************************************************************
  ...
  **
  **
  **  FILE       : test_setxattr_einval.c
  **
  **  PURPOSE    : To test the setxattr library call auditing.
  **
  **  DESCRIPTION: The test_setxattr_einval() function builds into the
 ...
 int test_setxattr_einval(laus_data* dataPtr) {
   ...
   // Execute system call
   dataPtr->laus_var_data.syscallData.result = syscall( __NR_setxattr, path, name, value, size, XATTR_CREATE );
