 /**********************************************************************
    ...
    **
    **  PURPOSE    : To test the setfsuid16 library call auditing.
    **
   ...
   int test_setfsuid16(laus_data* dataPtr) {
     ...
     if( ( rc = auditArg1( dataPtr,
                    AUDIT_ARG_IMMEDIATE, sizeof( secondFsuid ), &secondFsuid ) ) != 0 ) {
     ...
     // Execute system call
     dataPtr->laus_var_data.syscallData.result = syscall( __NR_setfsuid16, secondFsuid );
