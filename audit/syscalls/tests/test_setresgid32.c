 /**********************************************************************
    ...
    **
    **  PURPOSE    : To test the setresgid32 library call auditing.
    **
   ...
   int test_setresgid32(laus_data* dataPtr) {
     ...
     dataPtr->laus_var_data.syscallData.code = AUDIT_setresgid;
     ...
     if( ( rc = auditArg3( dataPtr,
                    ...
                    AUDIT_ARG_IMMEDIATE_u, sizeof( int ), &egid,
                    AUDIT_ARG_IMMEDIATE_u, sizeof( int ), &sgid ) ) != 0 ) {
     ...
     dataPtr->laus_var_data.syscallData.result = syscall( __NR_setresgid32, rgid, egid, sgid );
