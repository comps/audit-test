 /**********************************************************************
    ...
    **
    **  PURPOSE    : To test the setreuid16 library call auditing.
    **
...
int test_setreuid16(struct audit_data *context)
{
    int rc = 0;
    ...
    context->u.syscall.exit = syscall(__NR_setreuid16, rgid, egid);
