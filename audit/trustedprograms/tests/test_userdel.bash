...
for msg_1 in \
    "userdel: op=deleting user entries acct=$user res=success" \
    "userdel: op=deleting mail file acct=$user res=success" \
    "userdel: op=deleting home directory acct=$user res=success"
do
