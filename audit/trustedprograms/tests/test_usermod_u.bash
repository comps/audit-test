...
for msg_1 in \
    "usermod: op=changing uid acct=$user res=success" \
    "usermod: op=changing home directory acct=$user res=success" \
    "usermod: op=moving home directory acct=$user res=success" \
    "usermod: op=changing home directory owner acct=$user res=success" \
    "usermod: op=changing mail file owner acct=$user res=success"
do
