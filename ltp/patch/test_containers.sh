...
$LTPROOT/bin/ltp-pan -S -a $LTPROOT/results/containers -n ltp-containers -l /usr/local/eal4_testing/ltp/containers.rollup.log -o /usr/local/eal4_testing/ltp/containers.run.log -p -f $LTPROOT/runtest/containers
